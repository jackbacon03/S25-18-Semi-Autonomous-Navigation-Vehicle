...
/*
  PID CONTROL - BOTH SENSORS: Adjust motors based on line position using front and back sensors
*/
...
/*
  PID CONTROL - ONLY FRONT: Adjust motors based on line position using only the front sensor
*/
...
/*
  RAMP UP - ENABLE: Increment the Motors to the Desired Speed When Re-Turned on at High Speed
*/
void rampUpEnable() {

  // Save Desired Speed Level
  int speedTarget = baseSpeed;

  // Divide Desired Speed by 5
  ...
  // Apply Desired Speed (Resume as Normal)
